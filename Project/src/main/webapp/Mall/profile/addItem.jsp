...
<%			
	...
	<tr>
		...
		<td>
		<form name="f" method="post" action="<%=request.getContextPath()%>/Mall/order/updateItem.jsp">
		...
		<td><a href="<%=request.getContextPath()%>/Mall/order/deleteItem.jsp?pnum=<%=pb.getPnum()%>" class="btn btn-default">삭제</a>
	</tr>
	<%}%>
	<tr>
	<td colspan="8">
